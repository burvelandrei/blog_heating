...
class Publication(models.Model):
    ...
    content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, verbose_name='Тип публикации')
...
class Article(TimeStappedModel):
    ...
    tags = models.ManyToManyField(Tag, related_name='articles', null=True, blank=True, verbose_name="Теги")
...
class Video(TimeStappedModel):
    ...
    tags = models.ManyToManyField(Tag, related_name='videos', null=True, blank=True, verbose_name="Теги")
